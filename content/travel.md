...
The 5th EOU Fledglings Meeting will take place at the Faculty of Biology, University of Gdańsk (Wydział Biologii Uniwersytetu Gdańskiego), located at:

ul. Wita Stwosza 59, 80-314 Gdańsk.

The campus is easily accessible by public transport (please see details below).
<iframe src="https://www.google.com/maps?q=54.394989,18.5766151&z=17&output=embed" width="100%" height="400" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
...
* [SkyCash](https://www.skycash.com/en/)
...
Bus lines that connect the airport to the city: line 110 runs to Gdańsk Wrzeszcz station, and line 210 runs to Gdańsk Główny.
...
Simply download the app, find the closest bike, and scan the QR code to start. After your ride, return the bike to one of the stations and pay via the app.

### By Tram

The closest tram stops to the campus are Uniwersytet Gdański, operated by lines 5, 6, and 12.

You can buy tickets in the [JakDojade](https://jakdojade.pl/) app.
...
* SKM (Rapid City Railway): connects Gdańsk Główny ↔ Gdańsk Wrzeszcz, Sopot, Gdynia
* PKM (Pomeranian Metropolitan Railway): connects Gdańsk Główny and Wrzeszcz ↔ airport and towns west of Gdańsk

Both systems meet near the University of Gdańsk Campus, so you can arrive by either.

Closest stations:

* Gdańsk Przymorze-Uniwersytet (SKM)
* Gdańsk Strzyża (PKM)

⚠️ **Important:** Tickets for SKM and PKM are separate systems! You can buy them at ticket machines or via apps like [JakDojade](https://jakdojade.pl/), [SkyCash](https://www.skycash.com/en/), or [KOLEO](https://koleo.pl/).

### By Bus

The closest bus stops to the campus are:

* Biblioteka Główna UG — lines 149 and 199
* Uniwersytet Gdański — line 149

Tickets are available via [JakDojade](https://jakdojade.pl/).

Gdańsk and Gdynia each operate separate public transport systems. Tickets for Gdańsk transport are not valid in Gdynia, but Gdańsk's tickets cover buses and trams alike.
...
**Tip:** Gdańsk buses are red-and-beige, while Gdynia buses are blue-and-white. Sopot is served by both systems.